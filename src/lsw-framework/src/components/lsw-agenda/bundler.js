...
require(resolve("dev/bundlers/core/vuebundler.js")).bundle({
  ...
  module: true,
  id: "Lsw_agenda_components",
  output: __dirname + "/lsw-agenda.components.js",
  ignore: [],
});
...
require(resolve("dev/bundlers/core/htmlbundler.js")).bundle({
  ...
  module: true,
  id: "Lsw_agenda_js",
  output: __dirname + "/lsw-agenda.js",
  ignore: [],
  wrap: false,
});
...
require(resolve("dev/bundlers/core/htmlbundler.js")).bundle({
  ...
  module: false,
  id: "Lsw_agenda_css",
  output: __dirname + "/lsw-agenda.css",
  ignore: [],
  wrap: false,
});
...
Set_license: {
  ...
  prependFileSync(__dirname + "/lsw-agenda.css", licenseSource, "utf8");
  prependFileSync(__dirname + "/lsw-agenda.js", licenseSource, "utf8");
}