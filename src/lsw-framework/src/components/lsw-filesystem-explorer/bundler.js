...
require(resolve("dev/bundlers/core/vuebundler.js")).bundle({
  ...
  module: true,
  id: "Lsw_filesystem_explorer_components",
  output: __dirname + "/lsw-filesystem-explorer.components.js",
  ignore: [],
});
...
require(resolve("dev/bundlers/core/htmlbundler.js")).bundle({
  ...
  module: true,
  id: "Lsw_filesystem_explorer_js",
  output: __dirname + "/lsw-filesystem-explorer.js",
  ignore: [],
  wrap: false,
});
...
require(resolve("dev/bundlers/core/htmlbundler.js")).bundle({
  ...
  module: false,
  id: "Lsw_filesystem_explorer_css",
  output: __dirname + "/lsw-filesystem-explorer.css",
  ignore: [],
  wrap: false,
});
...
Set_license: {
  ...
  prependFileSync(__dirname + "/lsw-filesystem-explorer.css", licenseSource, "utf8");
  prependFileSync(__dirname + "/lsw-filesystem-explorer.js", licenseSource, "utf8");
}